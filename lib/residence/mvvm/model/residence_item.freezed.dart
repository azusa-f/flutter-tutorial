...
class _$ResidenceItemTearOff {
  ...
  _ResidenceItem call(
    ...
    return _ResidenceItem(
      ...
      nearesetStation: nearesetStation,
...
/// @nodoc
class _$ResidenceItemCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? floorImagePath = freezed,
    Object? buildingName = freezed,
    Object? residencePrice = freezed,
    Object? nearesetStation = freezed,
...
class _$_ResidenceItem with DiagnosticableTreeMixin implements _ResidenceItem {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResidenceItem(imagePath: $imagePath, floorImagePath: $floorImagePath, buildingName: $buildingName, residencePrice: $residencePrice, nearesetStation: $nearesetStation, roomInformation: $roomInformation, buildingInformation: $buildingInformation)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ResidenceItem'))
      ..add(DiagnosticsProperty('imagePath', imagePath))
      ..add(DiagnosticsProperty('floorImagePath', floorImagePath))
      ..add(DiagnosticsProperty('buildingName', buildingName))
      ..add(DiagnosticsProperty('residencePrice', residencePrice))
      ..add(DiagnosticsProperty('nearesetStation', nearesetStation))
      ..add(DiagnosticsProperty('roomInformation', roomInformation))
      ..add(DiagnosticsProperty('buildingInformation', buildingInformation));
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.floorImagePath, floorImagePath) &&
            const DeepCollectionEquality()
                .equals(other.buildingName, buildingName) &&
            const DeepCollectionEquality()
                .equals(other.residencePrice, residencePrice) &&
            const DeepCollectionEquality()
                .equals(other.nearesetStation, nearesetStation) &&
            const DeepCollectionEquality()
                .equals(other.roomInformation, roomInformation) &&
            const DeepCollectionEquality()
                .equals(other.buildingInformation, buildingInformation));
  }
